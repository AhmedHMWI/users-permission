...
Route::group(['middleware' => 'useradmin'], function () {
    ...
    Route::get('panel/stores/store_1', function () {
        return view('panel.stores.store_1');
    });

    Route::get('panel/stores/store_2', function () {
        return view('panel.stores.store_2');
    });

    Route::get('panel/stores/store_3', function () {
        return view('panel.stores.store_3');
    });

    Route::get('panel/stores/store_4', function () {
        return view('panel.stores.store_4');
    });
